        ...
        child: Obx(
          () => Column(
            children: [
              ...
              EglInputMultiLineField(
                ...
                onChanged: (value) {
                  ...
                  titleFocus = titleFocus
                      ? titleFocus
                      : articleEditController.titleArticleFocusNode.hasFocus;
              ...
              EglInputMultiLineField(
                ...
                onChanged: (value) {
                  ...
                  abstractFocus = abstractFocus
                      ? abstractFocus
                      : articleEditController.abstractArticleFocusNode.hasFocus;
                  // articleEditController.checkFields();
              ...
              20.ph,
              (articleEditController.imageCoverChanged ||
                      !articleEditController
                          .newArticle.coverImageArticle.isDefault)
                  ? 30.ph
                  : 20.ph,
              // Cover widget
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(
                      50.0), // ajusta el radio según sea necesario
                  border: Border.all(
                ...
                child: EglImageWidget(
                  ...
                  onChange: (ImageArticle image) {
                    ...
                    articleEditController.newArticle.coverImageArticle =
                        image.copyWith();
                    articleEditController.checkIsFormValid();
                    EglHelper.eglLogger('i',
                        'onChange: ${articleEditController.newArticle.coverImageArticle.toString()}');
                  },
                  onPressedDefault: (ImageArticle image) {
                    ...
                    articleEditController.checkIsFormValid();
                    EglHelper.eglLogger('i',
                        'onPressedDefault: ${articleEditController.newArticle.coverImageArticle.toString()}');
                  },
                  onPressedRestore: (ImageArticle image) {
                    ...
                    articleEditController.checkIsFormValid();
                    EglHelper.eglLogger('i',
                        'onPressedRestore: ${articleEditController.newArticle.coverImageArticle.toString()}');
                  },
                ),
              ),
              40.ph,
              if (articleEditController.newArticle.itemsArticle.isNotEmpty)
                ReorderableListView(
                  ...
                  children: [
                    for (ItemArticle item
                        in articleEditController.newArticle.itemsArticle)
                      Dismissible(
                        key: UniqueKey(),
                        ...
                        child: Container(
                            ...
                            padding:
                                const EdgeInsets.only(bottom: 10.0, top: 40.0),
                            decoration: const BoxDecoration(
                              // borderRadius: BorderRadius.circular(50.0), // ajusta el radio según sea necesario
                              border: Border(
                                top: BorderSide(
                                  color: EglColorsApp
                                      .borderTileArticleColor, // color del borde
                                  width: 2.0, // ancho del borde)
                                ),
                              ),
                            ),
                  ...
                  onReorder: (oldIndex, newIndex) {
                    ...
                    final ItemArticle item =
                        articleEditController.deleteItemArticle(oldIndex);
                    ...
                    children: [
                      EglCircleIconButton(
                        ...
                        onPressed: () {
                          ...
                          item.idArticleItemArticle =
                              articleEditController.newArticle.idArticle;
                          item.idItemArticle =
                              articleEditController.articleItemsCount;
                          item.imageItemArticle.modify(
                            src: EglImagesPath.appCoverDefault,
                            nameFile: EglHelper.getNameFilePath(
                                EglImagesPath.appCoverDefault),
                            isDefault: true,
                          );
...
// functions
  Future<String> validateTitle(String text,
      {int minLength = 0, int maxLength = 99999}) async {
    String textValidateTitle = '';
    ...
    if (text.isEmpty && minLength > 0) {
      ...
      textValidateTitle =
          'El título ha de tener $minLength carácteres como mínimo ';
    } else if (text.length > maxLength) {
      textValidateTitle =
          'El título ha de tener $maxLength carácteres como máximo ';
      // controller.getTe
    } else {
      textValidateTitle = '';
    }
  ...
  Future<String> validateAbstract(String text,
      {int minLength = 0, int maxLength = 99999}) async {
    String textValidateAbstract = '';
    ...
    if (text.isEmpty && minLength > 0) {
      ...
      textValidateAbstract =
          'El abstract ha de tener $minLength carácteres como mínimo ';
    } else if (text.length > maxLength) {
      textValidateAbstract =
          'El abstract ha de tener $maxLength carácteres como máximo ';
      // controller.getTe
    } else {
      textValidateAbstract = '';
    }
